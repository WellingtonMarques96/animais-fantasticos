!(function (t) {
  ...
  function (t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = A(t)) != t || t === E
          ...
          : ((e = P(F(t) / T)),
            t * (i = M(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + s >= 1 ? f / i : f * M(2, 1 - s)) * i >= 2 &&
              (e++, (i /= 2)),
            e + s >= a
              ? ((o = 0), (e = a))
              : e + s >= 1
              ? ((o = (t * i - 1) * M(2, n)), (e += s))
              : ((o = t * M(2, s - 1) * M(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[L]._b, a = u + t[I], s = e(+o), f = 0; f < n; f++)
        c[a + f] = s[i ? f : n - f - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    t.exports = function (t) {
      return function (n) {
        for (var r, u = o(n), c = e(u), a = c.length, s = 0, f = []; a > s; )
  ...
  function (t, n, r) {
    ...
    var e = r(2),
      ...
      J = function (t, n) {
        if (((t = w(t)), (n = x(n, !0)), t !== U || !o(C, n) || o(D, n))) {
          var r = P(t, n);
          return (
            !r || !o(C, n) || (o(t, N) && t[N][n]) || (r.enumerable = !0), r
          );
        }
      },
      $ = function (t) {
        for (var n, r = T(w(t)), e = [], i = 0; r.length > i; )
          o(C, (n = r[i++])) || n == N || n == a || e.push(n);
        return e;
      },
      Z = function (t) {
        for (
          var n, r = t === U, e = T(r ? D : w(t)), i = [], u = 0;
          e.length > u;

        )
          !o(C, (n = e[u++])) || (r && !o(U, n)) || i.push(C[n]);
        return i;
      };
    W ||
      (c(
        (L = function () {
          ...
          return i && V && G(U, t, { configurable: !0, set: n }), z(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(44).f = K),
      (r(46).f = Z),
      i && !r(30) && c(U, "propertyIsEnumerable", K, !0),
      (v.f = function (t) {
        return z(p(t));
      })),
  ...
  function (t, n, r) {
    ...
    function e(t, n, r) {
      ...
      t.hasAttribute(o) ||
        (n.forEach((t) => {
          setTimeout(() => e.addEventListener(t, i));
        }),
        t.setAttribute(o, ""));
    }
    function o() {
      ...
      t = new MutationObserver(function (n) {
        n[0].target.classList.contains("ativo") &&
          (t.disconnect(),
          document.querySelectorAll("[data-numero]").forEach((t) => {
            ...
            const o = setInterval(() => {
              (e += r),
                (t.innerText = e),
                e > n && ((t.innerText = n), clearInterval(o));
            }, 25 * Math.random());
          }));
      });
      const n = document.querySelector(".numeros");
    ...
    new (class {
      ...
      (function () {
        ...
        t && r.forEach((n) => t.addEventListener(n, o));
      })(),
      (function () {
